...
for pitchangle in [90]: # generates plots with different intial pitch angles
    ...
    tp = 100#time in tc ~ 50 error gets high for rk45, boris is much more accurate
    accuracy = 1e4 # more like sampling
    method = 'rk45'
    _2dplots = True
    ...
    if method == 'rk45':
        ...
        xline,yline,zline,Vx,Vy,Vz = Integrator.boris(dT,accuracy, S0, tp)
